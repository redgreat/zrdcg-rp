...
try:
    ...
    # 创建文档
    doc = SimpleDocTemplate("zr_data.pdf", pagesize=letter, leftMargin=36, rightMargin=36, topMargin=36,
                            bottomMargin=36)
    story = []
    ...
    logo = Image(logo_path, width=240, height=130,preserveAspectRatio=True, mask='auto')
    story.append(logo)
